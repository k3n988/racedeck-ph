-- Repair migration for projects where the event-content-images migration was
-- not applied before the organizer poster upload endpoint was enabled.
...
drop policy if exists event_content_images_org_read on public.event_content_images;
